...
SUPPORTED_LANGUAGES: List[str] = [
    ...
    "Hungarian",
    "Macedonian",
    # Extension languages used by the Indic25 fine-tuning corpus. The base
    # checkpoint is not claimed to support these; listing them allows a
    # fine-tuned checkpoint to use the wrapper's explicit language prompt.
    "Assamese",
    "Bengali",
    "Bodo",
    "Dogri",
